...
start.time <- Sys.time()
setwd("~/Documents/kaggle/coupon_prediction")
dir <- '~/Documents/kaggle/coupon_prediction/'
...
require(Matrix)
weightm <- c(2.00, 1.25, 1.25, 1.00, 4.50, 0.625, 0.4) # males weights
...
write.csv(submission, file="150912submit.csv", row.names=FALSE)
